...
class ProductCategoryUsecase extends Usecase
{
  public string $className;

  public function __construct()
  {
    $this->className = 'ProductCategoryUsecase';
  }
  ...
  public function getAll(array $filterData = []): array
  {
    ...
    try {
      $data = DB::connection(DatabaseEntity::SQL_READ)
        ->table(DatabaseEntity::PRODUCT_CATEGORY, 'c')
  ...
  public function getByID(int $id): array
  {
    ...
    try {
      $data = DB::connection(DatabaseEntity::SQL_READ)
        ->table(DatabaseEntity::PRODUCT_CATEGORY)
  ...
  public function create(Request $data): array
  {
    ...
    DB::beginTransaction();
    try {
      DB::table(DatabaseEntity::PRODUCT_CATEGORY)
        ->insert([
  ...
  public function delete(int $id): array
  {
    ...
    try {
      $delete = DB::table(DatabaseEntity::PRODUCT_CATEGORY)
        ->where('id', $id)
        ->update([
