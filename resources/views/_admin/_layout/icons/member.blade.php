<svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
        ...
        stroke="#776FFF" stroke-width="1.5" />
    <path d="M13 15C13 16.105 13 17 9 17C5 17 5 16.105 5 15C5 13.895 6.79 13 9 13C11.21 13 13 13.895 13 15Z"
        stroke="#776FFF" stroke-width="1.5" />
    <path opacity="0.5"
        ...
        stroke="#776FFF" stroke-width="1.5" />
    <path d="M19 12H15M19 9H14" stroke="#776FFF" stroke-width="1.5" stroke-linecap="round" />
    <path opacity="0.9" d="M19 15H16" stroke="black" stroke-width="1.5" stroke-linecap="round" />
</svg>
